<?php namespace App\Modules\Usersys\Controllers;
...
class UsersysController extends \BaseController {
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return View::make('usersys::site/user/index', compact('user'));
    }
    ...
    {
        return View::make('usersys::site/user/create');
    }
    ...
    public function getLogin()
    {
        ...
        return View::make('usersys::site/user/login');
    }
    ...
    {
        return View::make('usersys::site/user/forgot');
    }
    ...
    public function getReset( $token )
    {
        ...
        return View::make('usersys::site/user/reset')
        ->with('token',$token);
    }
    ...
    public function getProfile($username)
    {
        ...
        return View::make('usersys::site/user/profile', compact('user'));
    }
