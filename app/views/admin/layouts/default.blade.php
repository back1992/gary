			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						...
						<li{{ (Request::is('admin/privilege*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/privileges') }}}"><span class="glyphicon glyphicon-user"></span> Privileges</a></li>
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">
								<span class="glyphicon glyphicon-user"></span> @if (Auth::check())
    {{{ Auth::user()->username }}}
